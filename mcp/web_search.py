...
def info() -> dict:
    ...
    return {
        ...
        "tier": 5,
        "owner": "Dorian",
        "job": "Search the internet for references and answers.",
    }


def run(action: str = "default", **kwargs) -> McpResult:
    """Main entry point for this MCP."""
    write_log("Web Search MCP", kwargs.get("agent", "Unknown"), action, kwargs)
