...
def info() -> dict:
    ...
    return {
        ...
        "tier": 4,
        "owner": "Pixel-Core",
        "job": "Run unit/integration tests (Vitest, Jest).",
    }


def run(action: str = "default", **kwargs) -> McpResult:
    """Main entry point for this MCP."""
    write_log("Test Runner MCP", kwargs.get("agent", "Unknown"), action, kwargs)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("MCP 20: Test Runner MCP")
        print("Owner: Pixel-Core")
