...
def info() -> dict:
    ...
    return {
        ...
        "tier": 2,
        "owner": "Rook",
        "job": "Create, activate, deactivate named agents. Maintains REGISTRY.md.",
    }


def run(action: str = "default", **kwargs) -> McpResult:
    """Main entry point for this MCP."""
    write_log("Registry MCP", kwargs.get("agent", "Unknown"), action, kwargs)
