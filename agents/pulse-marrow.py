#!/usr/bin/env python3
"""
PulseMarrow Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseMarrow. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseMarrow asks it to.
...
class PulseMarrow(Agent):
    """Auto-generated agent script for PulseMarrow."""

    name = "PulseMarrow"
    department = "Quality"
    skill_file = "quality/pulse-marrow.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseMarrow."""
    agent = PulseMarrow()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseMarrow Agent — Quality")
        print("Usage: python pulse-marrow.py <message>")
        sys.exit(1)
