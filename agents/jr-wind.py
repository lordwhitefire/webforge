...
Areas: 16-20
Skill file: skills/build/jr-wind.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrWind",
        "action": "review",
        "message": f"I am JrWind (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
