#!/usr/bin/env python3
"""
JrWind Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrWind. It controls what the AI does.
THE BRAIN: The AI only reasons when JrWind asks it to.
...
class JrWind(Agent):
    """Auto-generated agent script for JrWind."""

    name = "JrWind"
    department = "Build"
    skill_file = "build/jr-wind.md"
...
def run(message, context=None):
    """Called when developer talks to JrWind."""
    agent = JrWind()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrWind Agent — Build")
        print("Usage: python jr-wind.py <message>")
        sys.exit(1)
