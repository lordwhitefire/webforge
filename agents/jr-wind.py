#!/usr/bin/env python3
"""
JrWind — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Wind. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 16-20
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrWind working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrWind",
            "action": "idle",
            "message": f"I am JrWind. No tasks assigned to me on the board. I own areas 16-20.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrWind. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
