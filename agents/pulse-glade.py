#!/usr/bin/env python3
"""
PulseGlade Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseGlade. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseGlade asks it to.
...
class PulseGlade(Agent):
    """Auto-generated agent script for PulseGlade."""

    name = "PulseGlade"
    department = "Quality"
    skill_file = "quality/pulse-glade.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseGlade."""
    agent = PulseGlade()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseGlade Agent — Quality")
        print("Usage: python pulse-glade.py <message>")
        sys.exit(1)
