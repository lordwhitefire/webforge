#!/usr/bin/env python3
"""
JanusHeron Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusHeron. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusHeron asks it to.
...
class JanusHeron(Agent):
    """Auto-generated agent script for JanusHeron."""

    name = "JanusHeron"
    department = "Quality"
    skill_file = "quality/janus-heron.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusHeron."""
    agent = JanusHeron()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusHeron Agent — Quality")
        print("Usage: python janus-heron.py <message>")
        sys.exit(1)
