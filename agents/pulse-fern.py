#!/usr/bin/env python3
"""
PulseFern Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseFern. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseFern asks it to.
...
class PulseFern(Agent):
    """Auto-generated agent script for PulseFern."""

    name = "PulseFern"
    department = "Quality"
    skill_file = "quality/pulse-fern.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseFern."""
    agent = PulseFern()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseFern Agent — Quality")
        print("Usage: python pulse-fern.py <message>")
        sys.exit(1)
