#!/usr/bin/env python3
"""
MemoryChoices — Documentation Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Memory-Choices. I am part of the Memory Team. I report to Quill.
Areas: N/A
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "MemoryChoices",
            "action": "idle",
            "message": f"I am MemoryChoices. No tasks assigned to me on the board. I own areas assigned.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"MemoryChoices COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am MemoryChoices. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
