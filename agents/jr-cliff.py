#!/usr/bin/env python3
"""
JrCliff Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrCliff. It controls what the AI does.
THE BRAIN: The AI only reasons when JrCliff asks it to.
...
class JrCliff(Agent):
    """Auto-generated agent script for JrCliff."""

    name = "JrCliff"
    department = "Build"
    skill_file = "build/jr-cliff.md"
...
def run(message, context=None):
    """Called when developer talks to JrCliff."""
    agent = JrCliff()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrCliff Agent — Build")
        print("Usage: python jr-cliff.py <message>")
        sys.exit(1)
