...
Areas: 46-50
Skill file: skills/build/jr-cliff.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCliff",
        "action": "review",
        "message": f"I am JrCliff (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
