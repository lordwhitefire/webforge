#!/usr/bin/env python3
"""
JrCliff — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Cliff. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 46-50
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrCliff working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrCliff",
            "action": "idle",
            "message": f"I am JrCliff. No tasks assigned to me on the board. I own areas 46-50.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrCliff. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
