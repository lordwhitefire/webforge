...
Areas: 46-50
Skill file: skills/build/jr-pine.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrPine",
        "action": "review",
        "message": f"I am JrPine (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
