#!/usr/bin/env python3
"""
JrPine — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Pine. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 46-50
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrPine working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrPine",
            "action": "idle",
            "message": f"I am JrPine. No tasks assigned to me on the board. I own areas 46-50.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrPine. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
