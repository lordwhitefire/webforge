#!/usr/bin/env python3
"""
JrPine Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrPine. It controls what the AI does.
THE BRAIN: The AI only reasons when JrPine asks it to.
...
class JrPine(Agent):
    """Auto-generated agent script for JrPine."""

    name = "JrPine"
    department = "Build"
    skill_file = "build/jr-pine.md"
...
def run(message, context=None):
    """Called when developer talks to JrPine."""
    agent = JrPine()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrPine Agent — Build")
        print("Usage: python jr-pine.py <message>")
        sys.exit(1)
