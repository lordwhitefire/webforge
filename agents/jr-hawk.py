...
def run(message, context=None):
    ...
    return {
        "agent": "JrHawk",
        "action": "review",
        "message": f"I am JrHawk (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
