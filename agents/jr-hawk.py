#!/usr/bin/env python3
"""
JrHawk — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Hawk. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 01-05
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrHawk working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrHawk",
            "action": "idle",
            "message": f"I am JrHawk. No tasks assigned to me on the board. I own areas 01-05.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrHawk. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
