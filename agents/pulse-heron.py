#!/usr/bin/env python3
"""
PulseHeron Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseHeron. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseHeron asks it to.
...
class PulseHeron(Agent):
    """Auto-generated agent script for PulseHeron."""

    name = "PulseHeron"
    department = "Quality"
    skill_file = "quality/pulse-heron.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseHeron."""
    agent = PulseHeron()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseHeron Agent — Quality")
        print("Usage: python pulse-heron.py <message>")
        sys.exit(1)
