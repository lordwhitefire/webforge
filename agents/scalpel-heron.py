#!/usr/bin/env python3
"""
ScalpelHeron — Quality Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Scalpel-Heron. I am a I write and run E2E tests in a real browser agent. I report to Scalpel-Core.
Areas: 71-75
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "ScalpelHeron",
            "action": "idle",
            "message": f"I am ScalpelHeron. No tasks assigned to me on the board. I own areas 71-75.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"ScalpelHeron COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am ScalpelHeron. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
