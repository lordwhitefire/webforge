#!/usr/bin/env python3
"""
SentryReed Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS SentryReed. It controls what the AI does.
THE BRAIN: The AI only reasons when SentryReed asks it to.
...
class SentryReed(Agent):
    """Auto-generated agent script for SentryReed."""

    name = "SentryReed"
    department = "Quality"
    skill_file = "quality/sentry-reed.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to SentryReed."""
    agent = SentryReed()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("SentryReed Agent — Quality")
        print("Usage: python sentry-reed.py <message>")
        sys.exit(1)
