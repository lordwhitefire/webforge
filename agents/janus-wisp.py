#!/usr/bin/env python3
"""
JanusWisp Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusWisp. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusWisp asks it to.
...
class JanusWisp(Agent):
    """Auto-generated agent script for JanusWisp."""

    name = "JanusWisp"
    department = "Quality"
    skill_file = "quality/janus-wisp.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusWisp."""
    agent = JanusWisp()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusWisp Agent — Quality")
        print("Usage: python janus-wisp.py <message>")
        sys.exit(1)
