#!/usr/bin/env python3
"""
PixelMarrow Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelMarrow. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelMarrow asks it to.
...
class PixelMarrow(Agent):
    """Auto-generated agent script for PixelMarrow."""

    name = "PixelMarrow"
    department = "Quality"
    skill_file = "quality/pixel-marrow.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelMarrow."""
    agent = PixelMarrow()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelMarrow Agent — Quality")
        print("Usage: python pixel-marrow.py <message>")
        sys.exit(1)
