...
Role: I am Odin-Wisp. I am an Odin Agent in the Intelligence team. I report to Odin-Lead.
Areas: 41-45
"""
...
def do_work(task):
    """Odin agent: research standards for areas 41-45."""
    log_to_memory(f"ODIN-OdinWisp researching standards for areas 41-45")
    return f"Researched standards for areas 41-45. Knowledge base updated."
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "OdinWisp",
            "action": "idle",
            "message": f"I am OdinWisp. No tasks assigned to me on the board. I own areas 41-45.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"OdinWisp COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am OdinWisp. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
