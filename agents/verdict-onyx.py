#!/usr/bin/env python3
"""
VerdictOnyx Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS VerdictOnyx. It controls what the AI does.
THE BRAIN: The AI only reasons when VerdictOnyx asks it to.
...
class VerdictOnyx(Agent):
    """Auto-generated agent script for VerdictOnyx."""

    name = "VerdictOnyx"
    department = "Quality"
    skill_file = "quality/verdict-onyx.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to VerdictOnyx."""
    agent = VerdictOnyx()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("VerdictOnyx Agent — Quality")
        print("Usage: python verdict-onyx.py <message>")
        sys.exit(1)
