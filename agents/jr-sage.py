...
Areas: 26-30
Skill file: skills/build/jr-sage.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrSage",
        "action": "review",
        "message": f"I am JrSage (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
