#!/usr/bin/env python3
"""
JrSage Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrSage. It controls what the AI does.
THE BRAIN: The AI only reasons when JrSage asks it to.
...
class JrSage(Agent):
    """Auto-generated agent script for JrSage."""

    name = "JrSage"
    department = "Build"
    skill_file = "build/jr-sage.md"
...
def run(message, context=None):
    """Called when developer talks to JrSage."""
    agent = JrSage()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrSage Agent — Build")
        print("Usage: python jr-sage.py <message>")
        sys.exit(1)
