#!/usr/bin/env python3
"""
JanusSlate Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusSlate. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusSlate asks it to.
...
class JanusSlate(Agent):
    """Auto-generated agent script for JanusSlate."""

    name = "JanusSlate"
    department = "Quality"
    skill_file = "quality/janus-slate.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusSlate."""
    agent = JanusSlate()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusSlate Agent — Quality")
        print("Usage: python janus-slate.py <message>")
        sys.exit(1)
