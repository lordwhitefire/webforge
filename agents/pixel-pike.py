#!/usr/bin/env python3
"""
PixelPike Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelPike. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelPike asks it to.
...
class PixelPike(Agent):
    """Auto-generated agent script for PixelPike."""

    name = "PixelPike"
    department = "Quality"
    skill_file = "quality/pixel-pike.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelPike."""
    agent = PixelPike()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelPike Agent — Quality")
        print("Usage: python pixel-pike.py <message>")
        sys.exit(1)
