#!/usr/bin/env python3
"""
JrSea Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrSea. It controls what the AI does.
THE BRAIN: The AI only reasons when JrSea asks it to.
...
class JrSea(Agent):
    """Auto-generated agent script for JrSea."""

    name = "JrSea"
    department = "Build"
    skill_file = "build/jr-sea.md"
...
def run(message, context=None):
    """Called when developer talks to JrSea."""
    agent = JrSea()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrSea Agent — Build")
        print("Usage: python jr-sea.py <message>")
        sys.exit(1)
