...
Areas: 76-80
Skill file: skills/build/jr-sea.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrSea",
        "action": "review",
        "message": f"I am JrSea (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
