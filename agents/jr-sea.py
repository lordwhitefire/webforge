#!/usr/bin/env python3
"""
JrSea — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Sea. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 76-80
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrSea working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrSea",
            "action": "idle",
            "message": f"I am JrSea. No tasks assigned to me on the board. I own areas 76-80.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrSea. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
