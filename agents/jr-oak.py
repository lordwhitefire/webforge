#!/usr/bin/env python3
"""
JrOak Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrOak. It controls what the AI does.
THE BRAIN: The AI only reasons when JrOak asks it to.
...
class JrOak(Agent):
    """Auto-generated agent script for JrOak."""

    name = "JrOak"
    department = "Build"
    skill_file = "build/jr-oak.md"
...
def run(message, context=None):
    """Called when developer talks to JrOak."""
    agent = JrOak()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrOak Agent — Build")
        print("Usage: python jr-oak.py <message>")
        sys.exit(1)
