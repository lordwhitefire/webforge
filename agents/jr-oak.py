...
Areas: 41-45
Skill file: skills/build/jr-oak.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrOak",
        "action": "review",
        "message": f"I am JrOak (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
