...
Areas: 31-35
Skill file: skills/intelligence/odin-fern.md
"""
...
def run(message, context=None):
    """Odin agent: researches standards for areas 31-35."""
    ...
    try:
        subprocess.run(["python3", str(MCP_DIR / "memory.py"), "session-append",
                       f"ODIN-OdinFern researched: {message[:80]}",
                       "OdinFern", "note"],
    ...
    return {
        ...
        "action": "research",
        "areas": "31-35",
        "message": f"I am OdinFern. I researched standards for areas 31-35. Topic: {message}. Found {len(findings)} existing knowledge entries.",
