#!/usr/bin/env python3
"""
JrRiver Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrRiver. It controls what the AI does.
THE BRAIN: The AI only reasons when JrRiver asks it to.
...
class JrRiver(Agent):
    """Auto-generated agent script for JrRiver."""

    name = "JrRiver"
    department = "Build"
    skill_file = "build/jr-river.md"
...
def run(message, context=None):
    """Called when developer talks to JrRiver."""
    agent = JrRiver()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrRiver Agent — Build")
        print("Usage: python jr-river.py <message>")
        sys.exit(1)
