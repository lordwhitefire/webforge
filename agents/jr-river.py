...
Areas: 61-65
Skill file: skills/build/jr-river.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrRiver",
        "action": "review",
        "message": f"I am JrRiver (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
