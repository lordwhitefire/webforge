...
Role: I am JrRiver. I am a Junior Build Developer. I report to Hephaestus.
Areas: varies
"""
...
def ack_task(task: dict):
    ...
    notify_agent("Developer", "TASK_ACK",
                 "@JrRiver ACK'd " + task_id + ": Junior Build Developer.", task_id)
    log_to_memory("JrRiver ACK — picked up " + task_id + ": Junior Build Developer", kind="decision")
