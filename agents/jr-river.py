#!/usr/bin/env python3
"""
JrRiver — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-River. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 61-65
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrRiver working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrRiver",
            "action": "idle",
            "message": f"I am JrRiver. No tasks assigned to me on the board. I own areas 61-65.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrRiver. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
