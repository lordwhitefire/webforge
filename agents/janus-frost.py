#!/usr/bin/env python3
"""
JanusFrost Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusFrost. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusFrost asks it to.
...
class JanusFrost(Agent):
    """Auto-generated agent script for JanusFrost."""

    name = "JanusFrost"
    department = "Quality"
    skill_file = "quality/janus-frost.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusFrost."""
    agent = JanusFrost()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusFrost Agent — Quality")
        print("Usage: python janus-frost.py <message>")
        sys.exit(1)
