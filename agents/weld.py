#!/usr/bin/env python3
"""
Weld Agent — Hr Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Weld. It controls what the AI does.
THE BRAIN: The AI only reasons when Weld asks it to.
...
class Weld(Agent):
    """Auto-generated agent script for Weld."""

    name = "Weld"
    department = "Hr"
    skill_file = "hr/weld.md"
    reports_to = "Hermes"
    can_route_to = ["Hermes"]
...
def run(message, context=None):
    """Called when developer talks to Weld."""
    agent = Weld()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Weld Agent — Hr")
        print("Usage: python weld.py <message>")
        sys.exit(1)
