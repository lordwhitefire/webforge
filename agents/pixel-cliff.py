#!/usr/bin/env python3
"""
PixelCliff Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelCliff. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelCliff asks it to.
...
class PixelCliff(Agent):
    """Auto-generated agent script for PixelCliff."""

    name = "PixelCliff"
    department = "Quality"
    skill_file = "quality/pixel-cliff.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelCliff."""
    agent = PixelCliff()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelCliff Agent — Quality")
        print("Usage: python pixel-cliff.py <message>")
        sys.exit(1)
