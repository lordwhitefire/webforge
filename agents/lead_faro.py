#!/usr/bin/env python3
"""
LeadFaro — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Lead-Faro. I am a Tech Lead in the Build team. I report to Aurora.
Areas: N/A
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "LeadFaro",
            "action": "idle",
            "message": f"I am LeadFaro. No tasks assigned to me on the board. I own areas assigned.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"LeadFaro COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am LeadFaro. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
