#!/usr/bin/env python3
"""
Quill — Documentation Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Quill. I am the Lead of Documentation. I report to Thoth.
Areas: N/A
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "Quill",
            "action": "idle",
            "message": f"I am Quill. No tasks assigned to me on the board. I own areas assigned.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"Quill COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am Quill. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
