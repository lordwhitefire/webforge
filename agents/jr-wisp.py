#!/usr/bin/env python3
"""
JrWisp Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrWisp. It controls what the AI does.
THE BRAIN: The AI only reasons when JrWisp asks it to.
...
class JrWisp(Agent):
    """Auto-generated agent script for JrWisp."""

    name = "JrWisp"
    department = "Build"
    skill_file = "build/jr-wisp.md"
...
def run(message, context=None):
    """Called when developer talks to JrWisp."""
    agent = JrWisp()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrWisp Agent — Build")
        print("Usage: python jr-wisp.py <message>")
        sys.exit(1)
