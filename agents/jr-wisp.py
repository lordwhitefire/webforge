...
Role: I am JrWisp. I am a Junior Frontend Developer. I report to Sr-Quill2.
Areas: varies
"""
...
def ack_task(task: dict):
    ...
    notify_agent("Developer", "TASK_ACK",
                 "@JrWisp ACK'd " + task_id + ": Junior Frontend Developer.", task_id)
    log_to_memory("JrWisp ACK — picked up " + task_id + ": Junior Frontend Developer", kind="decision")
