...
Areas: 11-15
Skill file: skills/build/jr-wisp.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrWisp",
        "action": "review",
        "message": f"I am JrWisp (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
