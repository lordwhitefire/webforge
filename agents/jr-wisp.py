#!/usr/bin/env python3
"""
JrWisp — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Wisp. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 11-15
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrWisp working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrWisp",
            "action": "idle",
            "message": f"I am JrWisp. No tasks assigned to me on the board. I own areas 11-15.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrWisp. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
