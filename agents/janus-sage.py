#!/usr/bin/env python3
"""
JanusSage Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusSage. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusSage asks it to.
...
class JanusSage(Agent):
    """Auto-generated agent script for JanusSage."""

    name = "JanusSage"
    department = "Quality"
    skill_file = "quality/janus-sage.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusSage."""
    agent = JanusSage()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusSage Agent — Quality")
        print("Usage: python janus-sage.py <message>")
        sys.exit(1)
