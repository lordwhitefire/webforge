#!/usr/bin/env python3
"""
JrEmber — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Ember. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 46-50
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrEmber working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrEmber",
            "action": "idle",
            "message": f"I am JrEmber. No tasks assigned to me on the board. I own areas 46-50.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrEmber. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
