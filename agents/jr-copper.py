...
Areas: 21-25
Skill file: skills/build/jr-copper.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCopper",
        "action": "review",
        "message": f"I am JrCopper (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
