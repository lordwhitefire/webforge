#!/usr/bin/env python3
"""
JrCopper — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Copper. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 21-25
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrCopper working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrCopper",
            "action": "idle",
            "message": f"I am JrCopper. No tasks assigned to me on the board. I own areas 21-25.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrCopper. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
