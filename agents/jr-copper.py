...
Role: I am Jr-Copper. I am a Junior Backend Developer. I report to Sr-Iron.
Areas: 21-25
"""
...
def ack_task(task: dict):
    ...
    notify_agent(superior, "TASK_ACK",
                 "ACK — picked up " + task_id + ": JrCopper.", task_id)
    notify_agent("Developer", "TASK_ACK",
                 "@JrCopper ACK'd " + task_id + ": JrCopper.", task_id)
    log_to_memory("JrCopper ACK — picked up " + task_id + ": JrCopper", kind="decision")
