#!/usr/bin/env python3
"""
JrAsh — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Ash. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 51-55
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrAsh working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrAsh",
            "action": "idle",
            "message": f"I am JrAsh. No tasks assigned to me on the board. I own areas 51-55.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrAsh. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
