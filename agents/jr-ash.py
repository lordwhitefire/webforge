#!/usr/bin/env python3
"""
JrAsh Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrAsh. It controls what the AI does.
THE BRAIN: The AI only reasons when JrAsh asks it to.
...
class JrAsh(Agent):
    """Auto-generated agent script for JrAsh."""

    name = "JrAsh"
    department = "Build"
    skill_file = "build/jr-ash.md"
...
def run(message, context=None):
    """Called when developer talks to JrAsh."""
    agent = JrAsh()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrAsh Agent — Build")
        print("Usage: python jr-ash.py <message>")
        sys.exit(1)
