...
Areas: 51-55
Skill file: skills/build/jr-ash.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrAsh",
        "action": "review",
        "message": f"I am JrAsh (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
