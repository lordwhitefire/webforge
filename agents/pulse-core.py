#!/usr/bin/env python3
"""
PulseCore Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseCore. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseCore asks it to.
...
class PulseCore(Agent):
    """Auto-generated agent script for PulseCore."""

    name = "PulseCore"
    department = "Quality"
    skill_file = "quality/pulse-core.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseCore."""
    agent = PulseCore()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseCore Agent — Quality")
        print("Usage: python pulse-core.py <message>")
        sys.exit(1)
