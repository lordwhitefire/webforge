#!/usr/bin/env python3
"""
PixelSage Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelSage. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelSage asks it to.
...
class PixelSage(Agent):
    """Auto-generated agent script for PixelSage."""

    name = "PixelSage"
    department = "Quality"
    skill_file = "quality/pixel-sage.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelSage."""
    agent = PixelSage()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelSage Agent — Quality")
        print("Usage: python pixel-sage.py <message>")
        sys.exit(1)
