#!/usr/bin/env python3
"""
SentryAster Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS SentryAster. It controls what the AI does.
THE BRAIN: The AI only reasons when SentryAster asks it to.
...
class SentryAster(Agent):
    """Auto-generated agent script for SentryAster."""

    name = "SentryAster"
    department = "Quality"
    skill_file = "quality/sentry-aster.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to SentryAster."""
    agent = SentryAster()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("SentryAster Agent — Quality")
        print("Usage: python sentry-aster.py <message>")
        sys.exit(1)
