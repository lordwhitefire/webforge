...
Areas: N/A
Skill file: skills/build/sr_hale.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrHale",
        "action": "review",
        "message": f"I am SrHale (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
