#!/usr/bin/env python3
"""
Sr_hale Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Sr_hale. It controls what the AI does.
THE BRAIN: The AI only reasons when Sr_hale asks it to.
...
class Sr_hale(Agent):
    """Auto-generated agent script for Sr_hale."""

    name = "Sr_hale"
    department = "Build"
    skill_file = "build/sr_hale.md"
...
def run(message, context=None):
    """Called when developer talks to Sr_hale."""
    agent = Sr_hale()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Sr_hale Agent — Build")
        print("Usage: python sr_hale.py <message>")
        sys.exit(1)
