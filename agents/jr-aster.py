...
Areas: 81-82
Skill file: skills/build/jr-aster.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrAster",
        "action": "review",
        "message": f"I am JrAster (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
