#!/usr/bin/env python3
"""
JrAster — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Aster. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 81-82
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrAster working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrAster",
            "action": "idle",
            "message": f"I am JrAster. No tasks assigned to me on the board. I own areas 81-82.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrAster. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
