#!/usr/bin/env python3
"""
JrAster Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrAster. It controls what the AI does.
THE BRAIN: The AI only reasons when JrAster asks it to.
...
class JrAster(Agent):
    """Auto-generated agent script for JrAster."""

    name = "JrAster"
    department = "Build"
    skill_file = "build/jr-aster.md"
...
def run(message, context=None):
    """Called when developer talks to JrAster."""
    agent = JrAster()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrAster Agent — Build")
        print("Usage: python jr-aster.py <message>")
        sys.exit(1)
