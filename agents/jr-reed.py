#!/usr/bin/env python3
"""
JrReed Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrReed. It controls what the AI does.
THE BRAIN: The AI only reasons when JrReed asks it to.
...
class JrReed(Agent):
    """Auto-generated agent script for JrReed."""

    name = "JrReed"
    department = "Build"
    skill_file = "build/jr-reed.md"
...
def run(message, context=None):
    """Called when developer talks to JrReed."""
    agent = JrReed()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrReed Agent — Build")
        print("Usage: python jr-reed.py <message>")
        sys.exit(1)
