...
Areas: 21-25
Skill file: skills/build/jr-reed.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrReed",
        "action": "review",
        "message": f"I am JrReed (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
