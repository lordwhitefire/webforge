...
Role: I am Odin-Cove. I am an Odin Agent in the Intelligence team. I report to Odin-Lead.
Areas: 46-50
"""
...
def do_work(task):
    """Odin agent: research standards for areas 46-50."""
    log_to_memory(f"ODIN-OdinCove researching standards for areas 46-50")
    return f"Researched standards for areas 46-50. Knowledge base updated."
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "OdinCove",
            "action": "idle",
            "message": f"I am OdinCove. No tasks assigned to me on the board. I own areas 46-50.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"OdinCove COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am OdinCove. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
