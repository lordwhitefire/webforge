#!/usr/bin/env python3
"""
OdinCove Agent — Intelligence Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS OdinCove. It controls what the AI does.
THE BRAIN: The AI only reasons when OdinCove asks it to.
...
class OdinCove(Agent):
    """Auto-generated agent script for OdinCove."""

    name = "OdinCove"
    department = "Intelligence"
    skill_file = "intelligence/odin-cove.md"
    reports_to = "Athena"
...
def run(message, context=None):
    """Called when developer talks to OdinCove."""
    agent = OdinCove()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("OdinCove Agent — Intelligence")
        print("Usage: python odin-cove.py <message>")
        sys.exit(1)
