#!/usr/bin/env python3
"""
JanusAster Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusAster. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusAster asks it to.
...
class JanusAster(Agent):
    """Auto-generated agent script for JanusAster."""

    name = "JanusAster"
    department = "Quality"
    skill_file = "quality/janus-aster.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusAster."""
    agent = JanusAster()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusAster Agent — Quality")
        print("Usage: python janus-aster.py <message>")
        sys.exit(1)
