...
def ack_task(task: dict):
    ...
    notify_agent(superior, "TASK_ACK",
                 "ACK — picked up " + task_id + ": JrMountain.", task_id)
    notify_agent("Developer", "TASK_ACK",
                 "@JrMountain ACK'd " + task_id + ": JrMountain.", task_id)
    log_to_memory("JrMountain ACK — picked up " + task_id + ": JrMountain", kind="decision")
