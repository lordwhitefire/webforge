#!/usr/bin/env python3
"""
JrMountain — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Mountain. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 21-25
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrMountain working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrMountain",
            "action": "idle",
            "message": f"I am JrMountain. No tasks assigned to me on the board. I own areas 21-25.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrMountain. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
