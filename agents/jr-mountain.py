...
Areas: 21-25
Skill file: skills/build/jr-mountain.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrMountain",
        "action": "review",
        "message": f"I am JrMountain (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
