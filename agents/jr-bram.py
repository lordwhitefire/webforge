#!/usr/bin/env python3
"""
JrBram Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrBram. It controls what the AI does.
THE BRAIN: The AI only reasons when JrBram asks it to.
...
class JrBram(Agent):
    """Auto-generated agent script for JrBram."""

    name = "JrBram"
    department = "Build"
    skill_file = "build/jr-bram.md"
...
def run(message, context=None):
    """Called when developer talks to JrBram."""
    agent = JrBram()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrBram Agent — Build")
        print("Usage: python jr-bram.py <message>")
        sys.exit(1)
