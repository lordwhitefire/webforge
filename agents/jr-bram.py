#!/usr/bin/env python3
"""
JrBram — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Bram. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 71-75
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrBram working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrBram",
            "action": "idle",
            "message": f"I am JrBram. No tasks assigned to me on the board. I own areas 71-75.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrBram. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
