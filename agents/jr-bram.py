...
Areas: 71-75
Skill file: skills/build/jr-bram.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrBram",
        "action": "review",
        "message": f"I am JrBram (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
