#!/usr/bin/env python3
"""
JrFlame Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrFlame. It controls what the AI does.
THE BRAIN: The AI only reasons when JrFlame asks it to.
...
class JrFlame(Agent):
    """Auto-generated agent script for JrFlame."""

    name = "JrFlame"
    department = "Build"
    skill_file = "build/jr-flame.md"
...
def run(message, context=None):
    """Called when developer talks to JrFlame."""
    agent = JrFlame()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrFlame Agent — Build")
        print("Usage: python jr-flame.py <message>")
        sys.exit(1)
