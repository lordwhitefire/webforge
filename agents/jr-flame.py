...
Areas: 41-45
Skill file: skills/build/jr-flame.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrFlame",
        "action": "review",
        "message": f"I am JrFlame (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
