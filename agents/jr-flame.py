#!/usr/bin/env python3
"""
JrFlame — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Flame. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 41-45
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrFlame working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrFlame",
            "action": "idle",
            "message": f"I am JrFlame. No tasks assigned to me on the board. I own areas 41-45.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrFlame. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
