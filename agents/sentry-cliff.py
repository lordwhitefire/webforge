#!/usr/bin/env python3
"""
SentryCliff Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS SentryCliff. It controls what the AI does.
THE BRAIN: The AI only reasons when SentryCliff asks it to.
...
class SentryCliff(Agent):
    """Auto-generated agent script for SentryCliff."""

    name = "SentryCliff"
    department = "Quality"
    skill_file = "quality/sentry-cliff.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to SentryCliff."""
    agent = SentryCliff()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("SentryCliff Agent — Quality")
        print("Usage: python sentry-cliff.py <message>")
        sys.exit(1)
