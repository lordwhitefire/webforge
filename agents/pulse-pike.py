#!/usr/bin/env python3
"""
PulsePike Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulsePike. It controls what the AI does.
THE BRAIN: The AI only reasons when PulsePike asks it to.
...
class PulsePike(Agent):
    """Auto-generated agent script for PulsePike."""

    name = "PulsePike"
    department = "Quality"
    skill_file = "quality/pulse-pike.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulsePike."""
    agent = PulsePike()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulsePike Agent — Quality")
        print("Usage: python pulse-pike.py <message>")
        sys.exit(1)
