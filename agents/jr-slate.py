#!/usr/bin/env python3
"""
JrSlate — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Slate. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 06-10
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrSlate working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrSlate",
            "action": "idle",
            "message": f"I am JrSlate. No tasks assigned to me on the board. I own areas 06-10.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrSlate. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
