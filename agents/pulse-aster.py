#!/usr/bin/env python3
"""
PulseAster Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseAster. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseAster asks it to.
...
class PulseAster(Agent):
    """Auto-generated agent script for PulseAster."""

    name = "PulseAster"
    department = "Quality"
    skill_file = "quality/pulse-aster.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseAster."""
    agent = PulseAster()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseAster Agent — Quality")
        print("Usage: python pulse-aster.py <message>")
        sys.exit(1)
