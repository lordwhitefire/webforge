#!/usr/bin/env python3
"""
SentrySlate Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS SentrySlate. It controls what the AI does.
THE BRAIN: The AI only reasons when SentrySlate asks it to.
...
class SentrySlate(Agent):
    """Auto-generated agent script for SentrySlate."""

    name = "SentrySlate"
    department = "Quality"
    skill_file = "quality/sentry-slate.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to SentrySlate."""
    agent = SentrySlate()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("SentrySlate Agent — Quality")
        print("Usage: python sentry-slate.py <message>")
        sys.exit(1)
