#!/usr/bin/env python3
"""
SentryWisp Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS SentryWisp. It controls what the AI does.
THE BRAIN: The AI only reasons when SentryWisp asks it to.
...
class SentryWisp(Agent):
    """Auto-generated agent script for SentryWisp."""

    name = "SentryWisp"
    department = "Quality"
    skill_file = "quality/sentry-wisp.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to SentryWisp."""
    agent = SentryWisp()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("SentryWisp Agent — Quality")
        print("Usage: python sentry-wisp.py <message>")
        sys.exit(1)
