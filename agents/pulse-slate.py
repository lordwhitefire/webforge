#!/usr/bin/env python3
"""
PulseSlate Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseSlate. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseSlate asks it to.
...
class PulseSlate(Agent):
    """Auto-generated agent script for PulseSlate."""

    name = "PulseSlate"
    department = "Quality"
    skill_file = "quality/pulse-slate.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseSlate."""
    agent = PulseSlate()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseSlate Agent — Quality")
        print("Usage: python pulse-slate.py <message>")
        sys.exit(1)
