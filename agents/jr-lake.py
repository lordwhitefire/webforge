...
Areas: 66-70
Skill file: skills/build/jr-lake.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrLake",
        "action": "review",
        "message": f"I am JrLake (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
