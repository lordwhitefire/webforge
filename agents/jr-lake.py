#!/usr/bin/env python3
"""
JrLake Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrLake. It controls what the AI does.
THE BRAIN: The AI only reasons when JrLake asks it to.
...
class JrLake(Agent):
    """Auto-generated agent script for JrLake."""

    name = "JrLake"
    department = "Build"
    skill_file = "build/jr-lake.md"
...
def run(message, context=None):
    """Called when developer talks to JrLake."""
    agent = JrLake()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrLake Agent — Build")
        print("Usage: python jr-lake.py <message>")
        sys.exit(1)
