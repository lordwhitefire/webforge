...
Role: I am Jr-Lake. I am a Junior Frontend Developer. I report to Sr-Hale.
Areas: 11-15
"""
...
def ack_task(task: dict):
    ...
    notify_agent(superior, "TASK_ACK",
                 "ACK — picked up " + task_id + ": JrLake.", task_id)
    notify_agent("Developer", "TASK_ACK",
                 "@JrLake ACK'd " + task_id + ": JrLake.", task_id)
    log_to_memory("JrLake ACK — picked up " + task_id + ": JrLake", kind="decision")
