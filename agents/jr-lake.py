#!/usr/bin/env python3
"""
JrLake — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Lake. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 66-70
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrLake working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrLake",
            "action": "idle",
            "message": f"I am JrLake. No tasks assigned to me on the board. I own areas 66-70.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrLake. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
