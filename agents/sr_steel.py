...
Areas: N/A
Skill file: skills/build/sr_steel.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrSteel",
        "action": "review",
        "message": f"I am SrSteel (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
