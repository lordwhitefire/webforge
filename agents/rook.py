#!/usr/bin/env python3
"""
Rook Agent — Hr Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Rook. It controls what the AI does.
THE BRAIN: The AI only reasons when Rook asks it to.
...
class Rook(Agent):
    """Auto-generated agent script for Rook."""

    name = "Rook"
    department = "Hr"
    skill_file = "hr/rook.md"
    reports_to = "Hermes"
    can_route_to = ["Hermes"]

    allowed_actions = ["answer_question", "route", "respond"]
    forbidden_actions = ["write_code", "create_bugfix_task", "create_feature_task", "run_standup", "research", "generate_docs", "run_quality_check", "review_code", "learn"]
...
def run(message, context=None):
    """Called when developer talks to Rook."""
    agent = Rook()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Rook Agent — Hr")
        print("Usage: python rook.py <message>")
        sys.exit(1)
