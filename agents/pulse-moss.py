#!/usr/bin/env python3
"""
PulseMoss Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseMoss. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseMoss asks it to.
...
class PulseMoss(Agent):
    """Auto-generated agent script for PulseMoss."""

    name = "PulseMoss"
    department = "Quality"
    skill_file = "quality/pulse-moss.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseMoss."""
    agent = PulseMoss()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseMoss Agent — Quality")
        print("Usage: python pulse-moss.py <message>")
        sys.exit(1)
