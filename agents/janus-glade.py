#!/usr/bin/env python3
"""
JanusGlade Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusGlade. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusGlade asks it to.
...
class JanusGlade(Agent):
    """Auto-generated agent script for JanusGlade."""

    name = "JanusGlade"
    department = "Quality"
    skill_file = "quality/janus-glade.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusGlade."""
    agent = JanusGlade()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusGlade Agent — Quality")
        print("Usage: python janus-glade.py <message>")
        sys.exit(1)
