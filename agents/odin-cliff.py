...
Role: I am Odin-Cliff. I am an Odin Agent in the Intelligence team. I report to Odin-Lead.
Areas: 16-20
"""
...
def do_work(task):
    """Odin agent: research standards for areas 16-20."""
    log_to_memory(f"ODIN-OdinCliff researching standards for areas 16-20")
    return f"Researched standards for areas 16-20. Knowledge base updated."
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "OdinCliff",
            "action": "idle",
            "message": f"I am OdinCliff. No tasks assigned to me on the board. I own areas 16-20.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"OdinCliff COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am OdinCliff. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
