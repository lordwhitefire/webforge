#!/usr/bin/env python3
"""
Sr_vance Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Sr_vance. It controls what the AI does.
THE BRAIN: The AI only reasons when Sr_vance asks it to.
...
class Sr_vance(Agent):
    """Auto-generated agent script for Sr_vance."""

    name = "Sr_vance"
    department = "Build"
    skill_file = "build/sr_vance.md"
...
def run(message, context=None):
    """Called when developer talks to Sr_vance."""
    agent = Sr_vance()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Sr_vance Agent — Build")
        print("Usage: python sr_vance.py <message>")
        sys.exit(1)
