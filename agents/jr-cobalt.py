...
Areas: 81-82
Skill file: skills/build/jr-cobalt.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCobalt",
        "action": "review",
        "message": f"I am JrCobalt (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
