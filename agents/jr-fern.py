#!/usr/bin/env python3
"""
JrFern Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrFern. It controls what the AI does.
THE BRAIN: The AI only reasons when JrFern asks it to.
...
class JrFern(Agent):
    """Auto-generated agent script for JrFern."""

    name = "JrFern"
    department = "Build"
    skill_file = "build/jr-fern.md"
...
def run(message, context=None):
    """Called when developer talks to JrFern."""
    agent = JrFern()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrFern Agent — Build")
        print("Usage: python jr-fern.py <message>")
        sys.exit(1)
