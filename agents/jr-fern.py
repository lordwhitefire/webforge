...
Areas: 51-55
Skill file: skills/build/jr-fern.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrFern",
        "action": "review",
        "message": f"I am JrFern (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
