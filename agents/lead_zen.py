#!/usr/bin/env python3
"""
Lead_zen Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Lead_zen. It controls what the AI does.
THE BRAIN: The AI only reasons when Lead_zen asks it to.
...
class Lead_zen(Agent):
    """Auto-generated agent script for Lead_zen."""

    name = "Lead_zen"
    department = "Build"
    skill_file = "build/lead_zen.md"
...
def run(message, context=None):
    """Called when developer talks to Lead_zen."""
    agent = Lead_zen()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Lead_zen Agent — Build")
        print("Usage: python lead_zen.py <message>")
        sys.exit(1)
