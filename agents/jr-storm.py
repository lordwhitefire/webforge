#!/usr/bin/env python3
"""
JrStorm — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Storm. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 06-10
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrStorm working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrStorm",
            "action": "idle",
            "message": f"I am JrStorm. No tasks assigned to me on the board. I own areas 06-10.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrStorm. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
