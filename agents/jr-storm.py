#!/usr/bin/env python3
"""
JrStorm Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrStorm. It controls what the AI does.
THE BRAIN: The AI only reasons when JrStorm asks it to.
...
class JrStorm(Agent):
    """Auto-generated agent script for JrStorm."""

    name = "JrStorm"
    department = "Build"
    skill_file = "build/jr-storm.md"
...
def run(message, context=None):
    """Called when developer talks to JrStorm."""
    agent = JrStorm()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrStorm Agent — Build")
        print("Usage: python jr-storm.py <message>")
        sys.exit(1)
