...
Areas: 06-10
Skill file: skills/build/jr-storm.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrStorm",
        "action": "review",
        "message": f"I am JrStorm (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
