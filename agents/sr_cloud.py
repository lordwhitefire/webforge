...
Areas: N/A
Skill file: skills/build/sr_cloud.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrCloud",
        "action": "review",
        "message": f"I am SrCloud (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
