#!/usr/bin/env python3
"""
JrPike Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrPike. It controls what the AI does.
THE BRAIN: The AI only reasons when JrPike asks it to.
...
class JrPike(Agent):
    """Auto-generated agent script for JrPike."""

    name = "JrPike"
    department = "Build"
    skill_file = "build/jr-pike.md"
...
def run(message, context=None):
    """Called when developer talks to JrPike."""
    agent = JrPike()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrPike Agent — Build")
        print("Usage: python jr-pike.py <message>")
        sys.exit(1)
