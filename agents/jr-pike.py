...
Areas: 36-40
Skill file: skills/build/jr-pike.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrPike",
        "action": "review",
        "message": f"I am JrPike (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
