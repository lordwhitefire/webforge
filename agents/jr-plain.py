...
Role: I am JrPlain. I am a Junior Build Developer. I report to Hephaestus.
Areas: varies
"""
...
def ack_task(task: dict):
    ...
    notify_agent("Developer", "TASK_ACK",
                 "@JrPlain ACK'd " + task_id + ": Junior Build Developer.", task_id)
    log_to_memory("JrPlain ACK — picked up " + task_id + ": Junior Build Developer", kind="decision")
