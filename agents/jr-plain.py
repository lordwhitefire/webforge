#!/usr/bin/env python3
"""
JrPlain — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Plain. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 36-40
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrPlain working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrPlain",
            "action": "idle",
            "message": f"I am JrPlain. No tasks assigned to me on the board. I own areas 36-40.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrPlain. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
