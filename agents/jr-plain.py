#!/usr/bin/env python3
"""
JrPlain Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrPlain. It controls what the AI does.
THE BRAIN: The AI only reasons when JrPlain asks it to.
...
class JrPlain(Agent):
    """Auto-generated agent script for JrPlain."""

    name = "JrPlain"
    department = "Build"
    skill_file = "build/jr-plain.md"
...
def run(message, context=None):
    """Called when developer talks to JrPlain."""
    agent = JrPlain()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrPlain Agent — Build")
        print("Usage: python jr-plain.py <message>")
        sys.exit(1)
