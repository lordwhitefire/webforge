...
Areas: 36-40
Skill file: skills/build/jr-plain.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrPlain",
        "action": "review",
        "message": f"I am JrPlain (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
