...
Role: I am JrQuartz. I am a Junior Frontend Developer. I report to Sr-Brook.
Areas: varies
"""
...
def ack_task(task: dict):
    ...
    notify_agent("Developer", "TASK_ACK",
                 "@JrQuartz ACK'd " + task_id + ": Junior Frontend Developer.", task_id)
    log_to_memory("JrQuartz ACK — picked up " + task_id + ": Junior Frontend Developer", kind="decision")
