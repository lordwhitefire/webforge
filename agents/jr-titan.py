...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrTitan",
            "action": "idle",
            "message": f"I am JrTitan. No tasks assigned to me on the board. I own areas 61-65.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrTitan. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
