#!/usr/bin/env python3
"""
JrTitan Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrTitan. It controls what the AI does.
THE BRAIN: The AI only reasons when JrTitan asks it to.
...
class JrTitan(Agent):
    """Auto-generated agent script for JrTitan."""

    name = "JrTitan"
    department = "Build"
    skill_file = "build/jr-titan.md"
...
def run(message, context=None):
    """Called when developer talks to JrTitan."""
    agent = JrTitan()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrTitan Agent — Build")
        print("Usage: python jr-titan.py <message>")
        sys.exit(1)
