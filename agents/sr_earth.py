...
Areas: N/A
Skill file: skills/build/sr_earth.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrEarth",
        "action": "review",
        "message": f"I am SrEarth (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
