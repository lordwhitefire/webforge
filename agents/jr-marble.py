...
Areas: 11-15
Skill file: skills/build/jr-marble.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrMarble",
        "action": "review",
        "message": f"I am JrMarble (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
