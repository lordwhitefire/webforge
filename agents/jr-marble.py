...
Role: I am Jr-Marble. I am a Junior Backend Developer. I report to Sr-Iron.
Areas: 31-35
"""
...
def ack_task(task: dict):
    ...
    notify_agent(superior, "TASK_ACK",
                 "ACK — picked up " + task_id + ": JrMarble.", task_id)
    notify_agent("Developer", "TASK_ACK",
                 "@JrMarble ACK'd " + task_id + ": JrMarble.", task_id)
    log_to_memory("JrMarble ACK — picked up " + task_id + ": JrMarble", kind="decision")
