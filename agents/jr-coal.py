...
Areas: 56-60
Skill file: skills/build/jr-coal.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCoal",
        "action": "review",
        "message": f"I am JrCoal (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
