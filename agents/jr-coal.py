#!/usr/bin/env python3
"""
JrCoal Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrCoal. It controls what the AI does.
THE BRAIN: The AI only reasons when JrCoal asks it to.
...
class JrCoal(Agent):
    """Auto-generated agent script for JrCoal."""

    name = "JrCoal"
    department = "Build"
    skill_file = "build/jr-coal.md"
...
def run(message, context=None):
    """Called when developer talks to JrCoal."""
    agent = JrCoal()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrCoal Agent — Build")
        print("Usage: python jr-coal.py <message>")
        sys.exit(1)
