#!/usr/bin/env python3
"""
JrCoal — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Coal. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 56-60
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrCoal working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrCoal",
            "action": "idle",
            "message": f"I am JrCoal. No tasks assigned to me on the board. I own areas 56-60.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrCoal. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
