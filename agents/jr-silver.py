...
Areas: 31-35
Skill file: skills/build/jr-silver.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrSilver",
        "action": "review",
        "message": f"I am JrSilver (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
