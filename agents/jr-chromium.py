...
Areas: 71-75
Skill file: skills/build/jr-chromium.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrChromium",
        "action": "review",
        "message": f"I am JrChromium (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
