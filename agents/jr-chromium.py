#!/usr/bin/env python3
"""
JrChromium — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Chromium. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 71-75
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrChromium working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrChromium",
            "action": "idle",
            "message": f"I am JrChromium. No tasks assigned to me on the board. I own areas 71-75.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrChromium. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
