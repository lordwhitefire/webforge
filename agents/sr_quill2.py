...
Areas: N/A
Skill file: skills/build/sr_quill2.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrQuill2",
        "action": "review",
        "message": f"I am SrQuill2 (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
