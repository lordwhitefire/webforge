#!/usr/bin/env python3
"""
JanusPike Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusPike. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusPike asks it to.
...
class JanusPike(Agent):
    """Auto-generated agent script for JanusPike."""

    name = "JanusPike"
    department = "Quality"
    skill_file = "quality/janus-pike.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusPike."""
    agent = JanusPike()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusPike Agent — Quality")
        print("Usage: python janus-pike.py <message>")
        sys.exit(1)
