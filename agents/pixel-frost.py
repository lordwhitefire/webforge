#!/usr/bin/env python3
"""
PixelFrost Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelFrost. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelFrost asks it to.
...
class PixelFrost(Agent):
    """Auto-generated agent script for PixelFrost."""

    name = "PixelFrost"
    department = "Quality"
    skill_file = "quality/pixel-frost.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelFrost."""
    agent = PixelFrost()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelFrost Agent — Quality")
        print("Usage: python pixel-frost.py <message>")
        sys.exit(1)
