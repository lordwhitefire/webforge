#!/usr/bin/env python3
"""
Sr_wood Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Sr_wood. It controls what the AI does.
THE BRAIN: The AI only reasons when Sr_wood asks it to.
...
class Sr_wood(Agent):
    """Auto-generated agent script for Sr_wood."""

    name = "Sr_wood"
    department = "Build"
    skill_file = "build/sr_wood.md"
...
def run(message, context=None):
    """Called when developer talks to Sr_wood."""
    agent = Sr_wood()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Sr_wood Agent — Build")
        print("Usage: python sr_wood.py <message>")
        sys.exit(1)
