...
Areas: N/A
Skill file: skills/build/sr_wood.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrWood",
        "action": "review",
        "message": f"I am SrWood (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
