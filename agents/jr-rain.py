#!/usr/bin/env python3
"""
JrRain — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Rain. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 11-15
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrRain working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrRain",
            "action": "idle",
            "message": f"I am JrRain. No tasks assigned to me on the board. I own areas 11-15.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrRain. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
