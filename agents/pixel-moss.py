#!/usr/bin/env python3
"""
PixelMoss Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelMoss. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelMoss asks it to.
...
class PixelMoss(Agent):
    """Auto-generated agent script for PixelMoss."""

    name = "PixelMoss"
    department = "Quality"
    skill_file = "quality/pixel-moss.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelMoss."""
    agent = PixelMoss()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelMoss Agent — Quality")
        print("Usage: python pixel-moss.py <message>")
        sys.exit(1)
