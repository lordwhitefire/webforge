#!/usr/bin/env python3
"""
JanusReed Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusReed. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusReed asks it to.
...
class JanusReed(Agent):
    """Auto-generated agent script for JanusReed."""

    name = "JanusReed"
    department = "Quality"
    skill_file = "quality/janus-reed.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusReed."""
    agent = JanusReed()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusReed Agent — Quality")
        print("Usage: python janus-reed.py <message>")
        sys.exit(1)
