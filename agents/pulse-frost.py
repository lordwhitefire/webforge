#!/usr/bin/env python3
"""
PulseFrost Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PulseFrost. It controls what the AI does.
THE BRAIN: The AI only reasons when PulseFrost asks it to.
...
class PulseFrost(Agent):
    """Auto-generated agent script for PulseFrost."""

    name = "PulseFrost"
    department = "Quality"
    skill_file = "quality/pulse-frost.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PulseFrost."""
    agent = PulseFrost()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PulseFrost Agent — Quality")
        print("Usage: python pulse-frost.py <message>")
        sys.exit(1)
