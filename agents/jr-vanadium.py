...
Areas: 66-70
Skill file: skills/build/jr-vanadium.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrVanadium",
        "action": "review",
        "message": f"I am JrVanadium (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
