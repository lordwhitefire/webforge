#!/usr/bin/env python3
"""
JrVanadium — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Vanadium. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 66-70
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrVanadium working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrVanadium",
            "action": "idle",
            "message": f"I am JrVanadium. No tasks assigned to me on the board. I own areas 66-70.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrVanadium. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
