#!/usr/bin/env python3
"""
JrHill — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Hill. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 26-30
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrHill working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrHill",
            "action": "idle",
            "message": f"I am JrHill. No tasks assigned to me on the board. I own areas 26-30.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrHill. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
