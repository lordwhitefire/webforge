#!/usr/bin/env python3
"""
JrHill Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrHill. It controls what the AI does.
THE BRAIN: The AI only reasons when JrHill asks it to.
...
class JrHill(Agent):
    """Auto-generated agent script for JrHill."""

    name = "JrHill"
    department = "Build"
    skill_file = "build/jr-hill.md"
...
def run(message, context=None):
    """Called when developer talks to JrHill."""
    agent = JrHill()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrHill Agent — Build")
        print("Usage: python jr-hill.py <message>")
        sys.exit(1)
