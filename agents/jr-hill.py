...
Areas: 26-30
Skill file: skills/build/jr-hill.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrHill",
        "action": "review",
        "message": f"I am JrHill (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
