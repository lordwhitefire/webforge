...
Areas: N/A
Skill file: skills/build/sr_stone.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrStone",
        "action": "review",
        "message": f"I am SrStone (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
