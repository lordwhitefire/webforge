#!/usr/bin/env python3
"""
Aurora Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Aurora. It controls what the AI does.
THE BRAIN: The AI only reasons when Aurora asks it to.
...
class Aurora(Agent):
    """Auto-generated agent script for Aurora."""

    name = "Aurora"
    department = "Build"
    skill_file = "build/aurora.md"
...
def run(message, context=None):
    """Called when developer talks to Aurora."""
    agent = Aurora()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Aurora Agent — Build")
        print("Usage: python aurora.py <message>")
        sys.exit(1)
