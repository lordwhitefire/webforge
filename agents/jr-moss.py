#!/usr/bin/env python3
"""
JrMoss Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrMoss. It controls what the AI does.
THE BRAIN: The AI only reasons when JrMoss asks it to.
...
class JrMoss(Agent):
    """Auto-generated agent script for JrMoss."""

    name = "JrMoss"
    department = "Build"
    skill_file = "build/jr-moss.md"
...
def run(message, context=None):
    """Called when developer talks to JrMoss."""
    agent = JrMoss()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrMoss Agent — Build")
        print("Usage: python jr-moss.py <message>")
        sys.exit(1)
