...
Areas: N/A
Skill file: skills/build/sr_water.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrWater",
        "action": "review",
        "message": f"I am SrWater (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
