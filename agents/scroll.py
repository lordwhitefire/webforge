#!/usr/bin/env python3
"""
Scroll — Documentation Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Scroll. I maintain the README and Changelog. I report to Quill.
Areas: N/A
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "Scroll",
            "action": "idle",
            "message": f"I am Scroll. No tasks assigned to me on the board. I own areas assigned.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"Scroll COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am Scroll. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
