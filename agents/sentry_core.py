#!/usr/bin/env python3
"""
Sentry_core Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Sentry_core. It controls what the AI does.
THE BRAIN: The AI only reasons when Sentry_core asks it to.
...
class Sentry_core(Agent):
    """Auto-generated agent script for Sentry_core."""

    name = "Sentry_core"
    department = "Quality"
    skill_file = "quality/sentry_core.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to Sentry_core."""
    agent = Sentry_core()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Sentry_core Agent — Quality")
        print("Usage: python sentry_core.py <message>")
        sys.exit(1)
