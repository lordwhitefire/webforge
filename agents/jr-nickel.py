...
Areas: 76-80
Skill file: skills/build/jr-nickel.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrNickel",
        "action": "review",
        "message": f"I am JrNickel (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
