...
Role: I am JrTalon. I am a Junior Backend Developer. I report to Sr-Iron.
Areas: 16-20
"""
...
def ack_task(task: dict):
    ...
    notify_agent("Developer", "TASK_ACK",
                 "@JrTalon ACK'd " + task_id + ": Junior Backend Developer.", task_id)
    log_to_memory("JrTalon ACK — picked up " + task_id + ": Junior Backend Developer", kind="decision")
