#!/usr/bin/env python3
"""
JrTalon Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrTalon. It controls what the AI does.
THE BRAIN: The AI only reasons when JrTalon asks it to.
...
class JrTalon(Agent):
    """Auto-generated agent script for JrTalon."""

    name = "JrTalon"
    department = "Build"
    skill_file = "build/jr-talon.md"
...
def run(message, context=None):
    """Called when developer talks to JrTalon."""
    agent = JrTalon()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrTalon Agent — Build")
        print("Usage: python jr-talon.py <message>")
        sys.exit(1)
