...
Areas: 76-80
Skill file: skills/build/jr-talon.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrTalon",
        "action": "review",
        "message": f"I am JrTalon (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
