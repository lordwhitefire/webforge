#!/usr/bin/env python3
"""
ScalpelFern Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS ScalpelFern. It controls what the AI does.
THE BRAIN: The AI only reasons when ScalpelFern asks it to.
...
class ScalpelFern(Agent):
    """Auto-generated agent script for ScalpelFern."""

    name = "ScalpelFern"
    department = "Quality"
    skill_file = "quality/scalpel-fern.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to ScalpelFern."""
    agent = ScalpelFern()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("ScalpelFern Agent — Quality")
        print("Usage: python scalpel-fern.py <message>")
        sys.exit(1)
