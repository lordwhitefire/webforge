#!/usr/bin/env python3
"""
JrBirch Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrBirch. It controls what the AI does.
THE BRAIN: The AI only reasons when JrBirch asks it to.
...
class JrBirch(Agent):
    """Auto-generated agent script for JrBirch."""

    name = "JrBirch"
    department = "Build"
    skill_file = "build/jr-birch.md"
...
def run(message, context=None):
    """Called when developer talks to JrBirch."""
    agent = JrBirch()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrBirch Agent — Build")
        print("Usage: python jr-birch.py <message>")
        sys.exit(1)
