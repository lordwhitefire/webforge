...
Areas: 56-60
Skill file: skills/build/jr-birch.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrBirch",
        "action": "review",
        "message": f"I am JrBirch (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
