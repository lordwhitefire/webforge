#!/usr/bin/env python3
"""
JrBirch — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Birch. I am a Junior Backend Developer. I report to my Senior Developer.
Areas: 56-60
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrBirch working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrBirch",
            "action": "idle",
            "message": f"I am JrBirch. No tasks assigned to me on the board. I own areas 56-60.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrBirch. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
