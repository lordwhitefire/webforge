#!/usr/bin/env python3
"""
OdinPike Agent — Intelligence Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS OdinPike. It controls what the AI does.
THE BRAIN: The AI only reasons when OdinPike asks it to.
...
class OdinPike(Agent):
    """Auto-generated agent script for OdinPike."""

    name = "OdinPike"
    department = "Intelligence"
    skill_file = "intelligence/odin-pike.md"
    reports_to = "Athena"
...
def run(message, context=None):
    """Called when developer talks to OdinPike."""
    agent = OdinPike()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("OdinPike Agent — Intelligence")
        print("Usage: python odin-pike.py <message>")
        sys.exit(1)
