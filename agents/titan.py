#!/usr/bin/env python3
"""
Titan Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Titan. It controls what the AI does.
THE BRAIN: The AI only reasons when Titan asks it to.
...
class Titan(Agent):
    """Auto-generated agent script for Titan."""

    name = "Titan"
    department = "Build"
    skill_file = "build/titan.md"
...
def run(message, context=None):
    """Called when developer talks to Titan."""
    agent = Titan()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Titan Agent — Build")
        print("Usage: python titan.py <message>")
        sys.exit(1)
