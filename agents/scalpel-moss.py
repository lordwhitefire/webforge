#!/usr/bin/env python3
"""
ScalpelMoss — Quality Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Scalpel-Moss. I am a I write and run E2E tests in a real browser agent. I report to Scalpel-Core.
Areas: 21-25
"""
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "ScalpelMoss",
            "action": "idle",
            "message": f"I am ScalpelMoss. No tasks assigned to me on the board. I own areas 21-25.",
            "next_step": None,
        }
    ...
    # Log to memory
    log_to_memory(f"ScalpelMoss COMPLETED {task_id}: {task_title} — {result_message}")
    ...
    return {
        ...
        "message": f"I am ScalpelMoss. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
