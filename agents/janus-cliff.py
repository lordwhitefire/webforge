#!/usr/bin/env python3
"""
JanusCliff Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusCliff. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusCliff asks it to.
...
class JanusCliff(Agent):
    """Auto-generated agent script for JanusCliff."""

    name = "JanusCliff"
    department = "Quality"
    skill_file = "quality/janus-cliff.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusCliff."""
    agent = JanusCliff()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusCliff Agent — Quality")
        print("Usage: python janus-cliff.py <message>")
        sys.exit(1)
