#!/usr/bin/env python3
"""
JrLake2 — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Lake2. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 81-82
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrLake2 working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrLake2",
            "action": "idle",
            "message": f"I am JrLake2. No tasks assigned to me on the board. I own areas 81-82.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrLake2. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
