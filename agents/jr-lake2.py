#!/usr/bin/env python3
"""
JrLake2 Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrLake2. It controls what the AI does.
THE BRAIN: The AI only reasons when JrLake2 asks it to.
...
class JrLake2(Agent):
    """Auto-generated agent script for JrLake2."""

    name = "JrLake2"
    department = "Build"
    skill_file = "build/jr-lake2.md"
...
def run(message, context=None):
    """Called when developer talks to JrLake2."""
    agent = JrLake2()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrLake2 Agent — Build")
        print("Usage: python jr-lake2.py <message>")
        sys.exit(1)
