...
Areas: 81-82
Skill file: skills/build/jr-lake2.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrLake2",
        "action": "review",
        "message": f"I am JrLake2 (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
