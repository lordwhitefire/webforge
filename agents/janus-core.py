#!/usr/bin/env python3
"""
JanusCore Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusCore. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusCore asks it to.
...
class JanusCore(Agent):
    """Auto-generated agent script for JanusCore."""

    name = "JanusCore"
    department = "Quality"
    skill_file = "quality/janus-core.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusCore."""
    agent = JanusCore()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusCore Agent — Quality")
        print("Usage: python janus-core.py <message>")
        sys.exit(1)
