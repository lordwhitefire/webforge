...
Areas: 51-55
Skill file: skills/build/jr-cedar.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCedar",
        "action": "review",
        "message": f"I am JrCedar (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
