#!/usr/bin/env python3
"""
JrCedar Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrCedar. It controls what the AI does.
THE BRAIN: The AI only reasons when JrCedar asks it to.
...
class JrCedar(Agent):
    """Auto-generated agent script for JrCedar."""

    name = "JrCedar"
    department = "Build"
    skill_file = "build/jr-cedar.md"
...
def run(message, context=None):
    """Called when developer talks to JrCedar."""
    agent = JrCedar()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrCedar Agent — Build")
        print("Usage: python jr-cedar.py <message>")
        sys.exit(1)
