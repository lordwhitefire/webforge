...
Areas: N/A
Skill file: skills/build/sr_fire.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "SrFire",
        "action": "review",
        "message": f"I am SrFire (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
