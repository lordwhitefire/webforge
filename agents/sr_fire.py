#!/usr/bin/env python3
"""
Sr_fire Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Sr_fire. It controls what the AI does.
THE BRAIN: The AI only reasons when Sr_fire asks it to.
...
class Sr_fire(Agent):
    """Auto-generated agent script for Sr_fire."""

    name = "Sr_fire"
    department = "Build"
    skill_file = "build/sr_fire.md"
...
def run(message, context=None):
    """Called when developer talks to Sr_fire."""
    agent = Sr_fire()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Sr_fire Agent — Build")
        print("Usage: python sr_fire.py <message>")
        sys.exit(1)
