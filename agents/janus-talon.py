#!/usr/bin/env python3
"""
JanusTalon Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusTalon. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusTalon asks it to.
...
class JanusTalon(Agent):
    """Auto-generated agent script for JanusTalon."""

    name = "JanusTalon"
    department = "Quality"
    skill_file = "quality/janus-talon.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusTalon."""
    agent = JanusTalon()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusTalon Agent — Quality")
        print("Usage: python janus-talon.py <message>")
        sys.exit(1)
