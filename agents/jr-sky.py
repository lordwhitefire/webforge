#!/usr/bin/env python3
"""
JrSky Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrSky. It controls what the AI does.
THE BRAIN: The AI only reasons when JrSky asks it to.
...
class JrSky(Agent):
    """Auto-generated agent script for JrSky."""

    name = "JrSky"
    department = "Build"
    skill_file = "build/jr-sky.md"
...
def run(message, context=None):
    """Called when developer talks to JrSky."""
    agent = JrSky()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrSky Agent — Build")
        print("Usage: python jr-sky.py <message>")
        sys.exit(1)
