...
Areas: 01-05
Skill file: skills/build/jr-sky.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrSky",
        "action": "review",
        "message": f"I am JrSky (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
