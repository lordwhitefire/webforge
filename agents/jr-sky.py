#!/usr/bin/env python3
"""
JrSky — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Sky. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 01-05
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrSky working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrSky",
            "action": "idle",
            "message": f"I am JrSky. No tasks assigned to me on the board. I own areas 01-05.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrSky. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
