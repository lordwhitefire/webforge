#!/usr/bin/env python3
"""
JrValley — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Valley. I am a Junior Database/Infra Developer. I report to my Senior Developer.
Areas: 31-35
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrValley working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrValley",
            "action": "idle",
            "message": f"I am JrValley. No tasks assigned to me on the board. I own areas 31-35.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrValley. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
