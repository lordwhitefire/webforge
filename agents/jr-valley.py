...
Areas: 31-35
Skill file: skills/build/jr-valley.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrValley",
        "action": "review",
        "message": f"I am JrValley (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
