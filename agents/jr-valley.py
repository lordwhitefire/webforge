...
Role: I am Jr-Valley. I am a Junior Frontend Developer. I report to Sr-Hale.
Areas: varies
"""
...
def ack_task(task: dict):
    ...
    notify_agent(superior, "TASK_ACK",
                 "ACK — picked up " + task_id + ": JrValley.", task_id)
    notify_agent("Developer", "TASK_ACK",
                 "@JrValley ACK'd " + task_id + ": JrValley.", task_id)
    log_to_memory("JrValley ACK — picked up " + task_id + ": JrValley", kind="decision")
