#!/usr/bin/env python3
"""
Zephyr Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS Zephyr. It controls what the AI does.
THE BRAIN: The AI only reasons when Zephyr asks it to.
...
class Zephyr(Agent):
    """Auto-generated agent script for Zephyr."""

    name = "Zephyr"
    department = "Build"
    skill_file = "build/zephyr.md"
...
def run(message, context=None):
    """Called when developer talks to Zephyr."""
    agent = Zephyr()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Zephyr Agent — Build")
        print("Usage: python zephyr.py <message>")
        sys.exit(1)
