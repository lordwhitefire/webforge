#!/usr/bin/env python3
"""
PixelFern Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS PixelFern. It controls what the AI does.
THE BRAIN: The AI only reasons when PixelFern asks it to.
...
class PixelFern(Agent):
    """Auto-generated agent script for PixelFern."""

    name = "PixelFern"
    department = "Quality"
    skill_file = "quality/pixel-fern.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to PixelFern."""
    agent = PixelFern()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("PixelFern Agent — Quality")
        print("Usage: python pixel-fern.py <message>")
        sys.exit(1)
