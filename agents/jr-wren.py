#!/usr/bin/env python3
"""
JrWren Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrWren. It controls what the AI does.
THE BRAIN: The AI only reasons when JrWren asks it to.
...
class JrWren(Agent):
    """Auto-generated agent script for JrWren."""

    name = "JrWren"
    department = "Build"
    skill_file = "build/jr-wren.md"
...
def run(message, context=None):
    """Called when developer talks to JrWren."""
    agent = JrWren()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrWren Agent — Build")
        print("Usage: python jr-wren.py <message>")
        sys.exit(1)
