...
Areas: 61-65
Skill file: skills/build/jr-wren.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrWren",
        "action": "review",
        "message": f"I am JrWren (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
