#!/usr/bin/env python3
"""
JrWren — Build Department
STANDALONE script. Checks board for assigned tasks and works on them.

Role: I am Jr-Wren. I am a Junior Frontend Developer. I report to my Senior Developer.
Areas: 61-65
"""
...
def do_work(task):
    ...
    log_to_memory(f"JrWren working on: {title}")
...
def run(message="work", context=None):
    ...
    if not my_tasks:
        return {
            "agent": "JrWren",
            "action": "idle",
            "message": f"I am JrWren. No tasks assigned to me on the board. I own areas 61-65.",
            "next_step": None,
        }
    ...
    return {
        ...
        "message": f"I am JrWren. I worked on {task_id}: {task_title}.\n  Result: {result_message}\n  Task marked DONE.",
        "next_step": None,
    }
