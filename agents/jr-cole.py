...
Areas: 16-20
Skill file: skills/build/jr-cole.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrCole",
        "action": "review",
        "message": f"I am JrCole (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
