#!/usr/bin/env python3
"""
JrCole Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrCole. It controls what the AI does.
THE BRAIN: The AI only reasons when JrCole asks it to.
...
class JrCole(Agent):
    """Auto-generated agent script for JrCole."""

    name = "JrCole"
    department = "Build"
    skill_file = "build/jr-cole.md"
...
def run(message, context=None):
    """Called when developer talks to JrCole."""
    agent = JrCole()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrCole Agent — Build")
        print("Usage: python jr-cole.py <message>")
        sys.exit(1)
