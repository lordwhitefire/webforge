#!/usr/bin/env python3
"""
JrGold Agent — Build Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JrGold. It controls what the AI does.
THE BRAIN: The AI only reasons when JrGold asks it to.
...
class JrGold(Agent):
    """Auto-generated agent script for JrGold."""

    name = "JrGold"
    department = "Build"
    skill_file = "build/jr-gold.md"
...
def run(message, context=None):
    """Called when developer talks to JrGold."""
    agent = JrGold()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JrGold Agent — Build")
        print("Usage: python jr-gold.py <message>")
        sys.exit(1)
