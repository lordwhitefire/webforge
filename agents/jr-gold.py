...
Areas: 36-40
Skill file: skills/build/jr-gold.md
"""
...
def run(message, context=None):
    ...
    return {
        "agent": "JrGold",
        "action": "review",
        "message": f"I am JrGold (Senior Dev). I review junior developers' work. {len(doing_tasks)} task(s) in progress. I report to my Tech Lead.",
