#!/usr/bin/env python3
"""
JanusCove Agent — Quality Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS JanusCove. It controls what the AI does.
THE BRAIN: The AI only reasons when JanusCove asks it to.
...
class JanusCove(Agent):
    """Auto-generated agent script for JanusCove."""

    name = "JanusCove"
    department = "Quality"
    skill_file = "quality/janus-cove.md"
    reports_to = "Minos"
...
def run(message, context=None):
    """Called when developer talks to JanusCove."""
    agent = JanusCove()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("JanusCove Agent — Quality")
        print("Usage: python janus-cove.py <message>")
        sys.exit(1)
