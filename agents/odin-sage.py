#!/usr/bin/env python3
"""
OdinSage Agent — Intelligence Department
Auto-generated by WebForge agent generator.

THE BODY: This script IS OdinSage. It controls what the AI does.
THE BRAIN: The AI only reasons when OdinSage asks it to.
...
class OdinSage(Agent):
    """Auto-generated agent script for OdinSage."""

    name = "OdinSage"
    department = "Intelligence"
    skill_file = "intelligence/odin-sage.md"
    reports_to = "Athena"
...
def run(message, context=None):
    """Called when developer talks to OdinSage."""
    agent = OdinSage()
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("OdinSage Agent — Intelligence")
        print("Usage: python odin-sage.py <message>")
        sys.exit(1)
